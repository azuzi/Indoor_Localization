...
public class ParticleFilter {
    ...
    void eliminate() throws Exception {
        ...
        for (int i = 0; i < numParticles; i++) {
            ...
            if (particles[i].x > 2.3 & particles[i].x <= 9.09 ){
                if (particles[i].y <= 9.0 | particles[i].y >= 14.04  ){
                    particles[i].set(particles[i].x, particles[i].y, particles[i].orientation,0.0);
                    count += 1;
                }
            }
            if (particles[i].x > 9.09 & particles[i].x <= 16.84 ){
                if (particles[i].y <= 9.0 | particles[i].y >= 10.65  ){
                    particles[i].set(particles[i].x, particles[i].y, particles[i].orientation, 0);
                    count += 1;
                }}
            if (particles[i].x > 16.84 & particles[i].x <= 19.14 ){
                if (particles[i].y <= 6.18 | particles[i].y >= 13.44  ){
                    particles[i].set(particles[i].x, particles[i].y, particles[i].orientation, 0);
                    count += 1;
                }}
            if (particles[i].x > 19.14 & particles[i].x <= 31.43 ){
                if (particles[i].y <= 9.0 | particles[i].y >= 10.65  ){
                    particles[i].set(particles[i].x, particles[i].y, particles[i].orientation, 0);
                    count += 1;
                }}
            if (particles[i].x > 31.43 | particles[i].x <= 2.3 ){
                    particles[i].set(particles[i].x, particles[i].y, particles[i].orientation, 0);
                count += 1;
            }
        }
